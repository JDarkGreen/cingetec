...
<nav class="pageProyectos__navigation">
	...
	<div class="pageWrapperLayout">
		...
		<div class="navigation-content">
			...
			?> <!-- Item -->
				<a href="<?= $rebuild_link; ?>" class="<?= $bussiness_line->post_name === $current_bussiness_line ? 'active' : '' ?> <?= $control_line === count($all_bussiness_line)-1 ? 'no-border' : '' ?> "> <?= $bussiness_line->post_title; ?>
				</a> <!-- / -->
